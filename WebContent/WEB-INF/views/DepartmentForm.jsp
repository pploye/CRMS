...
<section>
	<form:form modelAttribute="department">
		...
		<label><spring:message code="departmentId"
				text="Department ID" /></label>
		<form:input path="departmentId" id="departmentId" />

		<label><spring:message code="departmentName"
				text="Department Name" /></label>
		<form:input path="departmentName" id="departmentName" />

		<label><spring:message code="departmentDescription"
				text="Department Description" /></label>
		<form:input path="departmentDescription" id="departmentDescription" />

		<label><spring:message code="program" text="program" /></label>
		<form:select id="" path="registeredCourses" items="${programs}"
			itemLabel="name" itemValue="courseId" />


		<input type="submit"
			value="<spring:message code="department.add" text="Add Department"/>" />
